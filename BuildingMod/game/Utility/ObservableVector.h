...
public:
	...
	inline ObservableVector(const Vector& v) { *(int*)&_x = *(int*)&v.x; *(int*)&_y = *(int*)&v.y; *(int*)&_z = *(int*)&v.z; Notify(); }
	inline ObservableVector(const float rgfl[3]) { *(int*)&_x = *(int*)&rgfl[0]; *(int*)&_y = *(int*)&rgfl[1]; *(int*)&_z = *(int*)&rgfl[2]; Notify(); }
	...
	// Methods
	inline void CopyToArray(float* rgfl) const { *(int*)&rgfl[0] = *(int*)&_x; *(int*)&rgfl[1] = *(int*)&_y; *(int*)&rgfl[2] = *(int*)&_z; }
	...
	inline void x(float value) { _x = value; Notify(); }
	inline void y(float value) { _y = value; Notify(); }
	inline void z(float value) { _z = value; Notify(); }

	inline void setVector(float x, float y, float z) { _x = x; _y = y; _z = z; Notify(); }
