#ifndef _BUILDOBJECTS_FOUNDATION_FOUNDATIONTRIANGLE_
#define _BUILDOBJECTS_FOUNDATION_FOUNDATIONTRIANGLE_
...
#endif // !_BUILDOBJECTS_FOUNDATION_FOUNDATIONTRIANGLE_
